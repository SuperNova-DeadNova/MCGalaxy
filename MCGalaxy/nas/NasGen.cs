...
namespace NotAwesomeSurvival
{
    ...
    public static class NasGen
    {
        ...
        public static bool GetSeedAndChunkOffset(string mapName, ref string seed, ref int chunkOffsetX, ref int chunkOffsetZ)
        {
            ...
            if (!int.TryParse(chunks[0], out chunkOffsetX)) { return false; }
            if (!int.TryParse(chunks[1], out chunkOffsetZ)) { return false; }
            return true;
        }
        ...
        public class GenInstance
        {
                ...
                for (double y = 0; y < height; y++)
                {
                    ...
                    for (double z = 0; z < length; ++z)
                        for (double x = 0; x < width; ++x)
                        {
                            ...
                            {
                                if (biome == 1) { lvl.SetTile((ushort)x, (ushort)y, (ushort)z, Block.Sandstone); }
                                else
                                {
                                    if (biome < 0) { lvl.SetTile((ushort)x, (ushort)y, (ushort)z, 48); }
                                    else
                                    {
                                        lvl.SetTile((ushort)x, (ushort)y, (ushort)z, Block.Stone);
                                    }
                            ...
                            {
                                if (biome == 1) { lvl.SetTile((ushort)x, (ushort)y, (ushort)z, Block.Sand); }
                                else
                                {
                                    if (y == (oceanHeight - 1) && biome == 2) { lvl.SetTile((ushort)x, (ushort)y, (ushort)z, Block.Ice); }
                                    else
                                    {
                ...
                for (double y = 0; y < height; y++)
                {
                    ...
                    for (double z = 0; z < length; ++z)
                        for (double x = 0; x < width; ++x)
                        {
                            ...
                            int caveHeight = biome < 0 ? height : lvl.Height - 7;//nl.heightmap[(int)x, (int)z] - 7;
                            if (y > caveHeight)
                            {
            ...
            public ushort GetSoilType(int x, int z)
            {
                if (biome == 1)
                {
                    return Block.Sand;
            ...
            public static void GenerateDungeon(Random rng, Level level, NasLevel nsl)
            {
                ...
                int genY = rng.Next(10, mapTallness - 10);
            ...
            public static void GenLoot(int x, int y, int z, Level level, Random rng, NasLevel nsl)
            {
        ...
        //    public ushort treeLeaves;
        //    public ushort treeTrunk;
        //}
        ...
        //}
        //public static void Goto(SchedulerTask task) {
